...
echo '<form method="POST" action="apply_edit.php">
    ...
    <h1>Modifier votre réservation (admin): </h1>
    <table>
    ...
    Durée (h):<br> <input type="number" name="durée" id="durée" min="1" max="4" required value="'.$_POST["durée"].'">
    <br>Réserver le créneau combien de semaines<br> <input type="number" name="repeating" id="repeating" min="1" max="52"><br>
